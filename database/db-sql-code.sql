...
ALTER TYPE public.account_type OWNER TO cse340class3_user;
-- Table structure for table 'classificcation'
CREATE TABLE public.classification (
    classification_id INT GENERATED BY DEFAULT AS IDENTITY,
    classification_name CHARACTER VARYING NOT NULL,
    CONSTRAINT classificcation_pk PRIMARY KEY (classification_id)
);
